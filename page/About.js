document.addEventListener('DOMcontentLoaded',function(){
    ...
    ('container');
    const menuButton = documen.getElementById
    ('menu');
    const links =document.querySelectorAll
    ('a[href^="#"]');

    //function to handle the scroll 处理滚动的函数
    ...
    //Function to handle menu button click  处理菜单按钮点击的函数
    ...
    //Function to handle anchor links click 处理锚链接点击的函数
